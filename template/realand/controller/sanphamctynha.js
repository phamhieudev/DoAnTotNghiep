var app = angular.module('sanphamctynhaApp', []);

app.controller('sanphamctynhaCtrl', function ($scope, $http,$rootScope) {
  ...
  $http({
    method: "GET",
    url: "http://localhost:9090/sanphamctytheoloaitrangthaigd/15/1"
