var app = angular.module('sanphamusernhaApp', []);

app.controller('sanphamusernhaCtrl', function ($scope, $http,$rootScope) {
  ...
  $http({
    method: "GET",
    url: "http://localhost:9090/sanphamnguoidungtheonha/15/1/1"
